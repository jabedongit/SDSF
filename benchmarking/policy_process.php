...
{
$id = uniqidReal();  // id of the policy
...
$securityToken = tokenGenerate();  // generating SecurityToken. In full version, we will use json web token (JSON) 
...
// write to the policy file. Crea
$response['dataSharingPolicy'] = $dataSharingPolicy;
$newFileName = './policyRepositoy/'.$id.".json";
$fp = fopen($newFileName, 'w');
//fwrite($fp, '$response['dataSharingPolicy']');  Writing Policy in the JSON file.
